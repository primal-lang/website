...
(function dartProgram() {
  ...
  (function installTearOffs() {
    ...
    _static_1(A, "core_String___fromCharCode_tearOff$closure", "String___fromCharCode_tearOff", 24);
    var _;
    _instance_1_u(_ = A.Compiler.prototype, "get$compile", "compile$1", 10);
    _instance_1_u(_, "get$expression", "expression$1", 11);
    _instance_1_u(A.NodeWithArguments128.prototype, "get$getValue", "getValue$1", 12);
    _static_1(A, "parameter_Parameter___any_tearOff$closure", "Parameter___any_tearOff", 25);
    _instance_1_i(A.PlatformFileWeb.prototype, "get$length", "length$1", 15);
    _static_1(A, "node_LiteralNode_from$closure", "LiteralNode_from", 26);
    _static_1(A, "node_NumberNode___new_tearOff$closure", "NumberNode___new_tearOff", 27);
    _static_1(A, "node_StringNode___new_tearOff$closure", "StringNode___new_tearOff", 28);
    _instance_1_u(A.Runtime.prototype, "get$format", "format$1", 3);
    _static_0(A, "intermediate_code_IntermediateCode___empty_tearOff$closure", "IntermediateCode___empty_tearOff", 29);
    _static_1(A, "main_web__runtimeWarningsHelper$closure", "runtimeWarningsHelper", 30);
    _static_1(A, "main_web__runtimeHasMainHelper$closure", "runtimeHasMainHelper", 31);
    _static_1(A, "main_web__runtimeExecuteMainHelper$closure", "runtimeExecuteMainHelper", 32);
  ...
  var init = {
    ...
    mangledNames: {},
    types: ["Node(Node)", "@(Node)", "String(Parameter)", "@(@)", "Node(Expression)", "int(String?)", "~(@,@)", "~(@,Node)", "~(Object?,Object?)", "@(@,String)", "IntermediateCode(String)", "Expression(String)", "Node(@)", "~(String,@)", "NumberNode(@)", "int(File)", "@(String)", "int(Node,Node)", "MapEntry<Node,Node>(MapEntry<Node,Node>)", "Type(Parameter)", "Node(Parameter)", "String(IntermediateCode,Expression)", "MapEntry<Node,Node>(MapEntry<Expression,Expression>)", "String(GenericWarning)", "String(int)", "Parameter(String)", "LiteralNode<@>(@)", "NumberNode(num)", "StringNode(String)", "IntermediateCode()", "List<String>(IntermediateCode)", "bool(IntermediateCode)", "String(IntermediateCode)", "~(Symbol0,@)"],
