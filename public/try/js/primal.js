  ...
  A.ExpressionParser.prototype = {
    ...
    call$0() {
      ...
      for (t1 = type$.JSArray_Type; true;)
        if (_this.match$1(A._setArrayType([B.Type_OpenParenthesisToken_E4y], t1)))
