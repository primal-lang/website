...
(function dartProgram() {
  ...
  var A = {JS_CONST: function JS_CONST() {
    ...
    RuntimeError0: function RuntimeError0(t0) {
      this.message = t0;
    },
    ...
    FunctionWithMoreParametersState: function FunctionWithMoreParametersState(t0) {
      this.output = t0;
    },
  ...
  A.ListIterable.prototype = {
    get$iterator(_) {
      return new A.ListIterator(this, J.get$length$as(this._source), this.$ti._eval$1("ListIterator<ListIterable.E>"));
    },
    toList$0(_) {
  ...
  A.ListIterator.prototype = {
    ...
    moveNext$0() {
      ...
      t4 = _this.__internal$_index;
      if (t4 >= $length) {
        _this.set$__internal$_current(null);
        return false;
      }
      _this.set$__internal$_current(t1._f.call$1(t3.elementAt$1(t2, t4)));
  ...
  A.MappedIterable.prototype = {
    get$iterator(_) {
      ...
      return new A.MappedIterator(J.get$iterator$a(this.__internal$_iterable), this._f, t1._eval$1("@<1>")._bind$1(t1._rest[1])._eval$1("MappedIterator<1,2>"));
    },
    get$length(_) {
  ...
  A.SemanticAnalyzer.prototype = {
    ...
    checkDuplicatedParameters$1(functions) {
      ...
      for (t1 = functions.length, _i = 0; _i < functions.length; functions.length === t1 || (0, A.throwConcurrentModificationError)(functions), ++_i) {
        $function = functions[_i];
        for (t2 = this.parametersCount$1($function).get$entries(), t3 = A._instanceType(t2), t3 = t3._eval$1("@<1>")._bind$1(t3._rest[1]), t2 = new A.MappedIterator(J.get$iterator$a(t2.__internal$_iterable), t2._f, t3._eval$1("MappedIterator<1,2>")), t3 = t3._rest[1]; t2.moveNext$0();) {
  ...
  A.EmptyExpression.prototype = {
    toReducible$0() {
      return A.throwExpression(B.EmptyExpressionEvaluationError_oFO);
    }
  };
  ...
  A.FunctionWithParametersState.prototype = {
    process$2(input, next) {
      ...
      if (input instanceof A.SymbolToken) {
        t1 = this.output;
        t2 = A._asString(input.value);
        t3 = t1.name;
        t4 = A.List_List$of(t1.parameters, true, type$.String);
        t4.push(t2);
        return new A.FunctionWithMoreParametersState(new A.FunctionDefinition(t3, t4, t1.expression));
      } else if (input instanceof A.CloseParenthesisToken) {
        t1 = this.output;
        if (t1.parameters.length === 0)
          throw A.wrapException(A.InvalidTokenError$(input));
        return new A.FunctionParametrizedState(t1);
      } else
        throw A.wrapException(A.InvalidTokenError$(input));
    }
  };
  A.FunctionWithMoreParametersState.prototype = {
    process$2(input, next) {
      type$.Token_dynamic._as(input);
      type$.nullable_Token_dynamic._as(next);
  ...
  (function inheritance() {
    ...
    _inheritMany(A.State, [A.InitState0, A.CommentState, A.StringDoubleQuoteState, A.StringSingleQuoteState, A.NegativeNumberState, A.IntegerState, A.DecimalState, A.SymbolState, A.ResultState0, A.InitState, A.FunctionNameState, A.FunctionWithParametersState, A.FunctionWithMoreParametersState, A.FunctionParametrizedState, A.FunctionBodyInitState, A.FunctionBodyExpressionState, A.ResultState]);
